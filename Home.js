        ...
        <div className="container">
            <div className="form-section">
                ...
                <div className="role-buttons">
                    ...
                    <button onClick={() => navigate('/hr_admin')}>HR ADMIN</button>
            ...
            <div className="image-section">
                <img src="https://www.talintinternational.com/wp-content/uploads/2023/07/Employee-Skill-Training-Upskilling-Reskilling-and-Beyond-social-image-1.png" alt="Upskilling" />
            </div>
        </div>
    );
};
